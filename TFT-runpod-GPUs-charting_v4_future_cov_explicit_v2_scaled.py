...
def process_file(file_name, clean_data_folder, model_folder):
    ...
    try:
        ...
        data = data[(data['datetime'] >= '2022-01-01 01:15:00') & (data['datetime'] <= '2025-12-28 02:30:00')]         
        ...
        data2_columns = [  
            ...
            # Volume & Pressure
                ...
                # 'continuous_rolling_volume', 
                # 'continuous_market_pressure', 
                # 'sincos_upward_price_pressure','sincos_downward_price_pressure', 
                # 'continuous_obv', 
                # 'continuous_obv_cum',
                # 'continuous_obv_week_rolling', 
                # 'continuous_obv_two_weeks_rolling',
            ...
            # Momentum & Oscillators
                # 'continuous_momentum', 'continuous_rsi', 
                # 'continuous_macd', 'continuous_macd_signal',
                # # 'continuous_macd_hist', 
                # 'continuous_stoch_oscillator', 'continuous_stoch_signal',
            ...
            # Trend & MA Indicators
                ...
                'continuous_sma_short', 'continuous_sma_long', 'continuous_sma9','continuous_sma20', 'continuous_sma26', 'continuous_sma50',
            ...
            # Supertrend, SAR, ADX
                ...
                # 'continuous_adx', 
                'binary_adx_bull', 'binary_adx_bear',
        ...
        continuous_cols = [col for col in train_cov_series.columns if col.startswith('continuous_')] + ['open', 'high', 'low']
