...
def process_file(file_name, clean_data_folder, model_folder):
    ...
    "dmi_minus"
        ...
        my_model = TFTModel(
            ...
            n_epochs=25,                     # Количество эпох обучения модели (предыдущее значение: 100)
            ...
            add_encoders={
                'cyclic': {'future': ['month', 'hour', 'day_of_week', 'minute']},
        ...
        n_epochs_per_eval = 25  # Frequency of metric calculation (every epoch)
